...
## URL
https://dashboard.heroku.com/apps/dekiru-app-staging
*現在Productionは依頼人が非公開のため、Staging環境のURLになります。(2022/6/16現在)

## 製作背景
- 前職で仕事をしていた方より「住宅の現場でしか分からない生の情報を、動画付きで発信してみたい」というご相談を受けたのがきっかけです。「クラシル」というサービスをベースに、住宅バージョンを目指して作成しました。
...
### 「住宅という商品の中身を知ってもらいたい」という思い
- 「注文住宅を建てる」という経験は、人生においてほとんどない。そのため、その一発勝負に挑む前に様々な情報を提供したい。
...
## 使い方
- 欲しいコンテンツを見つける
条件検索・キーワード検索・カテゴリー検索など様々な方法で情報を見つけましょう。
